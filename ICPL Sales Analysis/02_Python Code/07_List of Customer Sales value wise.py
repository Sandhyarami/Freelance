...
grouped_data = data.groupby(['Customer']).agg(
...
total_row = pd.DataFrame({
    ...
    'Percentage': [100.0]  # 100% for the total row
})
...
output_path = r"D:/Sandhya/Analysis Insights/Data analysis/ICPL/31-7-2025/02_Output Data/07_List of Customer Sales value wise.xlsx"
with pd.ExcelWriter(output_path, engine='openpyxl') as writer:
    grouped_data.to_excel(writer, sheet_name='Customer Sales value wise', index=False)
