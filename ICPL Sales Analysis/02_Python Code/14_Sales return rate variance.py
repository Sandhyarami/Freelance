...
final_df = merged_df[['Date', 'Return_Date', 'Customer', 'Return_Customer', 'Item Name', 'Return_Item_Name', 'Voucher_No', 'Return_Voucher_Ref_No', 'Quantity', 'Return_Quantity','Rate' ,'Return_Rate']]
final_df.columns = ['Date', 'Return Date', 'Customer', 'Return Customer', 'Item Name', 'Return_Item_Name', 'Voucher No.', 'Return Voucher Ref. No.', 'Quantity', 'Return Quantity','Rate' ,'Return_Rate']

# ✅ Add Quantity Difference
final_df['Quantity Difference'] = final_df['Quantity'] - final_df['Return Quantity']

# ✅ Add Quantity Difference
final_df['Rate Difference'] = final_df['Rate'] - final_df['Return_Rate']

# ✅ Add Sr No.
final_df.insert(0, 'Sr No.', range(1, len(final_df) + 1))

# Save to single Excel sheet
output_path = r"D:/Sandhya/Analysis Insights/Data analysis/ICPL/31-7-2025/02_Output Data/14_Sales return rate variance.xlsx"
final_df.to_excel(output_path, index=False, sheet_name=' Rate Returns')
